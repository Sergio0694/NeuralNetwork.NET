...
namespace SharedBenchmark
{
    ...
    public static class MnistTester
    {
        ...
        public static async Task PerformBenchmarkAsync(LearningAlgorithmType type, int? batchSize, bool convolution, int? samplesLimit, bool cacheEnabled, params int[] neurons)
        {
